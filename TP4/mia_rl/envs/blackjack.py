...
# 1 represents an Ace, 2-10 represent the corresponding card values, and 10 is repeated four times to represent the face cards (Jack, Queen, King) which also have a value of 10.
